...
function ExperienceSection({experiences, className = "", id}: ExperienceSectionProps) {
                    ...
                    >
                        ...
                        <div className="relative bg-white shadow-2xl overflow-hidden border border-amber-700/40">
                            <div className="relative">
                                ...
                                <span
                                    className="absolute top-2 left-2 flex items-center justify-center w-9 h-9 bg-amber-950 text-amber-50 font-serif font-semibold text-sm border border-amber-700">
                                    {exp.number}
                                </span>
                            </div>
